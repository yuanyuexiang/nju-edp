...
- `10-*.md` is the admissions-system decision study; `13-*.md` is the banned/approval-gated wording checklist; `14-*.md` is the three-person scaled-down plan; `15-*.md` holds the landing-page checklist and B2B one-page template; `16-*.md` is the evidence-graded channel study; `17-*.md` is the configurable system blueprint derived from `10`.
